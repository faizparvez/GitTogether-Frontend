          ...
          <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 mt-1">Remote-First Company</p>
                    <p className="text-sm text-gray-500 mt-1">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg shadow-lg p-8 text-white">
              ...
              <div className="space-y-3">
                <a
                  href="#"
                  className="block w-full bg-white text-blue-600 font-semibold py-3 px-6 rounded-lg text-center hover:bg-blue-50 transition"
                >
                  Visit Help Center
                </a>
                <a
                  href="#"
                  className="block w-full bg-blue-500 text-white font-semibold py-3 px-6 rounded-lg text-center hover:bg-blue-400 transition"
                >
                  View Documentation
                </a>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="bg-blue-100 hover:bg-blue-200 text-blue-600 p-3 rounded-lg transition"
                  aria-label="Twitter"
                >
                  <svg
                    className="w-6 h-6"
