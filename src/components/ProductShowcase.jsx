      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="section-heading">
          ...
          <p className="section-description mt-5 text-lg text-center text-[#000000] max-w-3xl mx-auto leading-relaxed">
            Effortlessly connect with developers who share your passion and skills. 
            Our intelligent matching platform provides you with the tools to build 
            meaningful professional relationships, so you can focus on what really 
            matters - creating amazing projects together.
          </p>
        </div>
