...
<div className="section-heading mb-12 pt-2">
  ...
  <p className="section-description mt-5 text-lg text-center text-[#000000] max-w-3xl mx-auto leading-relaxed">
    Connect, collaborate and build meaningful projects with developers in your network.
    Strengthen your community and grow together.
  </p>
</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {connections.map((connection) => {
            const { _id, firstName, lastName, photoURL, age, gender, about, skills = [], interests = [], lookingFor = [] } =
              connection;
