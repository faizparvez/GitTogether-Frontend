        ...
        ">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[#00000088]">Send messages instantly</p>
            </div>
          </div>

          <p className="text-xs text-[#00000088]">
  {lastSeen ? `Last seen: ${formatTime(lastSeen)}` : "Loading last seen..."}
</p>
        ...
        >
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <p className="text-sm text-[#00000055]">Start the conversation!</p>
            </div>
          ) : (
